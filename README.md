## ESP32 Super Mini C3 - BME280 / DHT22 / MQTT

Projet PlatformIO pour ESP32-C3 Super Mini qui lit un capteur BME280 en I2C et un DHT22 sur GPIO4, affiche les mesures sur le port serie et les publie en JSON via MQTT.

La fiche projet complete est disponible dans [documents/fiche-info-projet.md](documents/fiche-info-projet.md).

### Fonctions principales

- Lecture temperature, humidite, pression et altitude via BME280
...
- BME280 : SDA GPIO8, SCL GPIO9, adresse I2C 0x76
- DHT22 : GPIO4
